...
import com.wyz.aidada.common.ReviewRequest;
...
import com.wyz.aidada.model.dto.app.AppAddRequest;
import com.wyz.aidada.model.dto.app.AppEditRequest;
import com.wyz.aidada.model.dto.app.AppQueryRequest;
import com.wyz.aidada.model.dto.app.AppUpdateRequest;
import com.wyz.aidada.model.entity.App;
import com.wyz.aidada.model.entity.User;
import com.wyz.aidada.model.enums.ReviewStatusEnum;
import com.wyz.aidada.model.vo.AppVO;
import com.wyz.aidada.service.AppService;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        if (!ReviewStatusEnum.ACCEPT.equals(ReviewStatusEnum.getEnumByValue(app.getReviewStatus()))){
    ...
    public BaseResponse<Page<AppVO>> listAppVOByPage(@RequestBody AppQueryRequest appQueryRequest,
        ...
        appQueryRequest.setReviewStatus(ReviewStatusEnum.ACCEPT.getValue());
        // 查询数据库
        Page<App> appPage = appService.page(new Page<>(current, size),
                appService.getQueryWrapper(appQueryRequest));
        // 获取封装类
