...
import com.wyz.aidada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        Byte scoringStrategy = app.getScoringStrategy();
        ...
        if (add) {
            ...
            AppScoringStrategyEnum scoringStategyEnum = AppScoringStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(scoringStategyEnum == null, ErrorCode.PARAMS_ERROR, "评分策略非法");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        Byte appType = appQueryRequest.getAppType();
        Byte scoringStrategy = appQueryRequest.getScoringStrategy();
